...
function CreateOrder() {
  ...
  // fix: selectedProduct added to dependency array so the preview panel updates
  // whenever the dropdown selection changes (previously only re-ran when products loaded)
  useEffect(() => {
    if (selectedProduct) {
